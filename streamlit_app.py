...
def main():
    ...
    selected_data = {col: 0 for col in columns_for_df_2}
    ...
    for feature, (min_val, max_val, default_val) in numerical_features.items():
        if feature in ['MonthlyIncome', 'PercentSalaryHike']:
            selected_data[feature] = st.text_input(feature, "Type Here") 
        else:
